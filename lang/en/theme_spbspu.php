...
/**
 * Strings for component 'theme_spbspu', language 'ru'
 *
...
$string['configtitle'] = 'СПбГПУ – настройки темы';
$string['customcss'] = 'Custom CSS';
$string['customcssdesc'] = 'Any CSS you enter here will be added to every page allowing your to easily customise this theme.';
$string['defaulttagline'] = 'Система дистанционного обучения';
...
$string['loginhere'] = 'Войти';
$string['newaccount'] = 'Зарегистрироваться';
$string['logo'] = 'Логотип';
